...
public class PlantWidgetProvider extends AppWidgetProvider {
    ...
    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        views.setImageViewResource(R.id.widget_plant_image, src);
    ...
    public void updatePlantWidgets(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds, int src) {
        ...
        for (int appWidgetId : appWidgetIds) {
            updateAppWidget(context, appWidgetManager, appWidgetId, src);
        }
    }
